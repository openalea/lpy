...
class Ui_FloatScalarDialog(object):
    ...
    def retranslateUi(self, FloatScalarDialog):
        FloatScalarDialog.setWindowTitle(_translate("FloatScalarDialog", "Scalar", None))
        self.label.setText(_translate("FloatScalarDialog", "Name", None))
        self.label_2.setText(_translate("FloatScalarDialog", "value", None))
        self.label_3.setText(_translate("FloatScalarDialog", "Minimum value", None))
        self.label_4.setText(_translate("FloatScalarDialog", "Maximum value", None))
        self.label_5.setText(_translate("FloatScalarDialog", "Decimals", None))
