...
#
# Created: Mon Nov 02 17:39:29 2009
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.centralwidget.setGeometry(QtCore.QRect(0, 55, 987, 548))
        ...
        self.gridLayout_3.addWidget(self.materialDock, 0, 1, 4, 1)
        self.functionDock = QtGui.QDockWidget(self.centralwidget)
        self.functionDock.setObjectName("functionDock")
        self.dockWidgetContents_6 = QtGui.QWidget()
        self.dockWidgetContents_6.setGeometry(QtCore.QRect(0, 22, 80, 348))
        self.dockWidgetContents_6.setObjectName("dockWidgetContents_6")
        self.verticalLayout_4 = QtGui.QVBoxLayout(self.dockWidgetContents_6)
        self.verticalLayout_4.setSpacing(2)
        self.verticalLayout_4.setMargin(0)
        self.verticalLayout_4.setObjectName("verticalLayout_4")
        self.functionpanel = FunctionPanel(self.dockWidgetContents_6)
        self.functionpanel.setObjectName("functionpanel")
        self.verticalLayout_4.addWidget(self.functionpanel)
        self.funcNameEdit = QtGui.QLineEdit(self.dockWidgetContents_6)
        self.funcNameEdit.setObjectName("funcNameEdit")
        self.verticalLayout_4.addWidget(self.funcNameEdit)
        self.functionDock.setWidget(self.dockWidgetContents_6)
        self.gridLayout_3.addWidget(self.functionDock, 0, 3, 4, 1)
        ...
        self.gridLayout_3.addWidget(self.parametersDock, 0, 4, 4, 1)
        self.descriptionDock = QtGui.QDockWidget(self.centralwidget)
        self.descriptionDock.setObjectName("descriptionDock")
        self.dockWidgetContents_4 = QtGui.QWidget()
        self.dockWidgetContents_4.setGeometry(QtCore.QRect(0, 22, 80, 348))
        ...
        self.page_2.setGeometry(QtCore.QRect(0, 0, 80, 336))
        ...
        self.gridLayout_3.addWidget(self.descriptionDock, 0, 5, 4, 1)
        ...
        self.dockWidgetContents_5.setGeometry(QtCore.QRect(0, 22, 80, 348))
        ...
        self.gridLayout_3.addWidget(self.helpDock, 0, 6, 4, 1)
        ...
        self.gridLayout_3.addWidget(self.frameGoto, 1, 7, 1, 1)
        ...
        spacerItem4 = QtGui.QSpacerItem(61, 23, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        ...
        self.gridLayout_3.addWidget(self.frameFind, 2, 7, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.frameReplace, 3, 7, 1, 1)
        ...
        self.dockWidgetContents.setGeometry(QtCore.QRect(0, 22, 883, 132))
        ...
        self.gridLayout_3.addWidget(self.interpreterDock, 4, 1, 1, 7)
        self.curveDock = QtGui.QDockWidget(self.centralwidget)
        self.curveDock.setObjectName("curveDock")
        self.dockWidgetContents_7 = QtGui.QWidget()
        self.dockWidgetContents_7.setGeometry(QtCore.QRect(0, 22, 80, 228))
        ...
        self.curvepanel = CurvePanel(self.dockWidgetContents_7)
        self.curvepanel.setObjectName("curvepanel")
        self.verticalLayout_8.addWidget(self.curvepanel)
        self.curveNameEdit = QtGui.QLineEdit(self.dockWidgetContents_7)
        self.curveNameEdit.setObjectName("curveNameEdit")
        self.verticalLayout_8.addWidget(self.curveNameEdit)
        self.curveDock.setWidget(self.dockWidgetContents_7)
        self.gridLayout_3.addWidget(self.curveDock, 0, 2, 1, 1)
        ...
        self.dockWidgetContents_8.setGeometry(QtCore.QRect(0, 22, 80, 228))
        ...
        self.statusbar.setGeometry(QtCore.QRect(0, 603, 987, 19))
        ...
        self.LsytemBar.setGeometry(QtCore.QRect(352, 21, 635, 34))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.functionDock.setWindowTitle(QtGui.QApplication.translate("MainWindow", "Functions", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.curveDock.setWindowTitle(QtGui.QApplication.translate("MainWindow", "Curves", None, QtGui.QApplication.UnicodeUTF8))
...
from curvepanel import CurvePanel, FunctionPanel
