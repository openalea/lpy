...
/*---------------------------------------------------------------------------*/
  ...
  {
    return MatchingEngine::match(it, const_begin(), const_end(), pattern.const_begin(), pattern.const_end(),
				 resultingpos, last_matched, filter, params);
  }
				...
				const ConsiderFilterPtr filter) const
  {
    ...
    return MatchingEngine::reverse_match(it, begin(), end(), pattern.const_rbegin(), pattern.const_rend(), resultingpos,
					 filter, params);
  }
			     ...
			     const ConsiderFilterPtr filter) const
  {
    ...
    return MatchingEngine::right_match(it, const_begin(), const_end(), pattern.const_begin(), pattern.const_end(),
				       last_matched, resultingpos, filter, params);
  }
  ...
  {
    if (pattern.empty())return true;
    return MatchingEngine::left_match(it, const_begin(), const_end(), pattern.const_rbegin(), pattern.const_rend(),
				      resultingpos, filter, params);
  }
