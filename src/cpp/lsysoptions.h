...
/*---------------------------------------------------------------------------*/
  ...
  class LPY_API LsysOption
  {
   public:
    ...
    iterator begin()
    { return __optionvalues.begin(); }

    const_iterator begin() const
    { return __optionvalues.begin(); }

    iterator end()
    { return __optionvalues.end(); }

    const_iterator end() const
    { return __optionvalues.end(); }

    size_t size() const
    { return __optionvalues.size(); }

    bool empty() const
    { return __optionvalues.empty(); }
    ...
    size_t getCurrentValueId() const
    { return current_value_id; }

    void setCurrentValueId(size_t);

    const std::string &currentValue() const
    { return __optionvalues[current_value_id]->name; }

    size_t defaultValueId() const
    { return default_value_id; }

    bool isToDefault() const
    { return current_value_id == default_value_id; }

    void setDefault(size_t value)
    {
      current_value_id = value;
      default_value_id = value;
    }
