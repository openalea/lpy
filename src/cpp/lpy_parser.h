...
/*---------------------------------------------------------------------------*/
									    ...
									    bool production = false)
    {
      ...
      return parselstring(beg, lcode.end(), '\n', lineno);
    }
...
/*---------------------------------------------------------------------------*/
    ...
    {
      std::string::const_iterator it = modules.begin();
      return parse_moddeclist(it, modules.end());
    }
    ...
    {
      std::string::const_iterator it = modules.begin();
      return parse_modlist(it, modules.end());
    }
...
/*---------------------------------------------------------------------------*/
    ...
    static inline bool isAConstant(std::string str)
    { return isAConstant(str.begin(), str.end()); }
