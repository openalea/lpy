...
/*---------------------------------------------------------------------------*/
  ...
  class LPY_API Lsystem
  {
   public:
    ...
    /** nb of iterations */
    inline size_t derivationLength() const
    { return __max_derivation; }

    inline void setDerivationLength(size_t v)
    { __max_derivation = v; }

    inline size_t decompositionMaxDepth() const
    { return __decomposition_max_depth; }

    inline void setDecompositionMaxDepth(size_t v)
    { __decomposition_max_depth = v; }

    inline size_t interpretationMaxDepth() const
    { return __interpretation_max_depth; }

    inline void setInterpretationMaxDepth(size_t v)
    { __interpretation_max_depth = v; }

    /** context */
    inline LsysContext *context()
    { return &__context; }

    inline const LsysContext *context() const
    { return &__context; }

    /** make current or disable the context of self */
    inline void makeCurrent()
    { return __context.makeCurrent(); }

    inline bool isCurrent() const
    { return __context.isCurrent(); }

    inline void done()
    { return __context.done(); }

    /** direction of iteration */
    inline eDirection getDirection() const
    { return __context.getDirection(); }
    ...
    size_t getLastIterationNb()
    { return __context.getIterationNb(); }

    PGL(ScenePtr) getLastComputedScene()
    { return __lastcomputedscene; }
	...
	if (alwaysStop) return true;
	  ...
	  return codeHasBreakPointAt(rule) ||
	...
	return it != linebreaks.end();
      ...
      inline void insertLstringBreakPointAt(AxialTree::const_iterator breakpoint)
      { lstringbreaks.push_back(breakpoint); }
	...
	clearLstringBreakPoints();
      }

      inline void clearCodeBreakPoints()
      { linebreaks.clear(); }

      inline void clearLstringBreakPoints()
      { lstringbreaks.clear(); }
    ...
    inline void setDebugger(DebuggerPtr debugger)
    { __debugger = debugger; }

    inline DebuggerPtr getDebugger() const
    { return __debugger; }

    inline bool hasDebugger() const
    { return is_valid_ptr(__debugger); }

    inline void clearDebugger()
    { __debugger = DebuggerPtr(); }
