...
/*---------------------------------------------------------------------------*/
  ...
  PredefinedModuleClass::PredefinedModuleClass(const std::string &name, const std::string &alias,
					       const std::string &doc, eCategory _category) :
...
#define DeclareModuleReal1(modname, doc, category) \
  ...
  DeclareModuleBegin(nF,
      ...
      switch (nbargs)
	{
	  case 0:
	  case 1:
	    LsysWarning("missing argument to nF");
	  break;
	  case 2:
	    t.nF(m._getReal(0), m._getReal(1));
	  break;
	  case 3:
	    t.nF(m._getReal(0), m._getReal(1), m._getReal(2));
	  break;
	  default:
  ...
  DeclareModuleBegin(GetFrame, "Request turtle frame information. Params : 'p,h,u,l' (optional, filled by Turtle).",
		     eRequest)
  ...
  DeclareModuleBegin(stopPolygon, "Pop a polygon from the stack and render it. Params : concavetest (default=False).",
		     ePrimitive)
    {
      size_t nbargs = m.size();
      switch (nbargs)
  ...
  DeclareModuleBegin(MoveTo, "Set the turtle position. Params : 'x, y, z' or 'v' (optionals, default = 0).", ePosition)
      ...
      switch (nbargs)
	{
	  ...
	  case 2:
	    t.move(m._getReal(0), m._getReal(1));
	  break;
	  default:
	    t.move(m._getReal(0), m._getReal(1), m._getReal(2));
	  break;
	}
    }
  DeclareModuleEnd
  ...
  DeclareModuleBegin(moveRel,
      ...
      switch (nbargs)
	{
	  ...
	  case 2:
	    t.shift(m._getReal(0), m._getReal(1));
	  break;
	  default:
	    t.shift(m._getReal(0), m._getReal(1), m._getReal(2));
	  break;
	}
#endif
    }
	  ...
	  case 1:
	    {
	      ...
	      if (ex.check())
		{ t.lineTo(ex()); }
	      else t.lineTo(m._getReal(0), 0, 0);
	      break;
	    }
	  case 2:
	    {
	      bp::extract<Vector3> ex(m.getAt(0));
	      if (ex.check())
		{ t.lineTo(ex(), m._getReal(1)); }
	      else t.lineTo(m._getReal(0), m._getReal(1));
	      break;
	    }
	  case 3:
	    t.lineTo(m._getReal(0), m._getReal(1), m._getReal(2));
	  break;
	  default:
	    t.lineTo(m._getReal(0), m._getReal(1), m._getReal(2), m._getReal(3));
	  break;
	}
#endif
    }
  ...
  DeclareModuleBegin(orientedLineTo,
	  ...
	  case 2:
	    {
	      bp::extract<Vector3> ex(m.getAt(0));
	      if (ex.check())
		{ t.oLineTo(ex(), m._getReal(1)); }
	      else t.oLineTo(m._getReal(0), m._getReal(1));
	      break;
	    }
	  case 3:
	    t.oLineTo(m._getReal(0), m._getReal(1), m._getReal(2));
	  break;
	  default:
	    t.oLineTo(m._getReal(0), m._getReal(1), m._getReal(2), m._getReal(3));
	  break;
	}
#endif
    }
  ...
  DeclareModuleBegin(pinPoint, "Orient turtle toward (x,y,z) . Params : 'x, y, z' or 'v' (optionals, default = 0).",
		     eRotation)
    {
#if PGL_VERSION >= 0x020B00
      size_t nbargs = m.size();
      switch (nbargs)
	{
	  ...
	  case 2:
	    t.pinpoint(m._getReal(0), m._getReal(1));
	  break;
	  default:
	    t.pinpoint(m._getReal(0), m._getReal(1), m._getReal(2));
	  break;
	}
#endif
    }
	  ...
	  case 2:
	    {
	      bp::extract<Vector3> ex(m.getAt(0));
	      if (ex.check())
		{ t.lineRel(ex(), m._getReal(1)); }
	      else t.lineRel(m._getReal(0), m._getReal(1));
	      break;
	    }
	  case 3:
	    t.lineRel(m._getReal(0), m._getReal(1), m._getReal(2));
	  break;
	  default:
	    t.lineRel(m._getReal(0), m._getReal(1), m._getReal(2), m._getReal(3));
	  break;
	}
#endif
    }
	  ...
	  case 2:
	    {
	      bp::extract<Vector3> ex(m.getAt(0));
	      if (ex.check())
		{ t.oLineRel(ex(), m._getReal(1)); }
	      else t.oLineRel(m._getReal(0), m._getReal(1));
	      break;
	    }
	  case 3:
	    t.oLineRel(m._getReal(0), m._getReal(1), m._getReal(2));
	  break;
	  default:
	    t.oLineRel(m._getReal(0), m._getReal(1), m._getReal(2), m._getReal(3));
	  break;
	}
#endif
    }
  ...
  DeclareModuleBegin(pinPointRel,
      ...
      switch (nbargs)
	{
	  ...
	  case 2:
	    t.pinpointRel(m._getReal(0), m._getReal(1));
	  break;
	  default:
	    t.pinpointRel(m._getReal(0), m._getReal(1), m._getReal(2));
	  break;
	}
#endif
    }
  ...
  DeclareModuleBegin(eulerAngles,
  ...
  DeclareModuleReal1(iRollL, "Roll left intrinsically around Heading vector. Params : 'angle' (optional, in degrees).",
		     eRotation)

  DeclareModuleReal1(iRollR, "Roll right intrinsically around Heading vector. Params : 'angle' (optional, in degrees).",
		     eRotation)
...
#warning RollToVert module with parameter will be disabled. Upgrade PlantGL.
  ...
  DeclareModuleBegin(rollToHorizontal, "Roll to Horizontal : Roll the turtle so that H lie in the horizontal plane",
		     eRotation)
    {
#if PGL_VERSION >= 0x021500
      switch (m.size())
	{
	  ...
	  break;
	  default:
	    t.rollToHorizontal(m._getReal(0));
	  break;
	}
#else
...
#warning RollToHorizontal module will be disabled. Upgrade PlantGL.
  ...
  DeclareModuleBegin(box, "Draw a box. Params : 'length','topradius'.", ePrimitive)
      ...
      switch (m.size())
	{
	  ...
	  break;
	  default:
	    t.box(m._getReal(0), m._getReal(1));
	  break;
	}
#endif
    }
  ...
  DeclareModuleBegin(quad, "Draw a quad. Params : 'length','topradius'.", ePrimitive)
      ...
      switch (m.size())
	{
	  ...
	  break;
	  default:
	    t.quad(m._getReal(0), m._getReal(1));
	  break;
	}
#endif
    }
  ...
  DeclareModuleBegin(setColor,
		     "Set the current material. Params : 'index' (positive int) or 'r,g,b[,a]' or 'material'.", eColor)
    {
  ...
  DeclareModuleBegin(interpolateColors, "Set the current material. Params : 'index1', 'index2', 'alpha' .", eColor)
      ...
      switch (nbargs)
	{
	  ...
	  case 2:
	    t.interpolateColors(m._getInt(0), m._getInt(1));
	  break;
	  default:
	    t.interpolateColors(m._getInt(0), m._getInt(1), m._getReal(2));
	  break;
	}
#else
#ifdef _MSC_VER
...
#warning InterpolateColors module will be disabled. Upgrade PlantGL.
  ...
  DeclareModuleBegin(textureBaseColor,
	  ...
	  if (nbatt == 1)
	    {
	      ...
	      if (appextractor.check())
		t.setTextureBaseColor(Color4(appextractor()->getDiffuseColor(), appextractor()->getTransparency()));
...
#warning TextureBaseColor module will be disabled. Upgrade PlantGL.
  ...
  DeclareModuleBegin(interpolateTextureBaseColors,
      ...
      switch (nbargs)
	{
	  ...
	  case 2:
	    t.interpolateTextureBaseColors(m._getInt(0), m._getInt(1));
	  break;
	  default:
	    t.interpolateTextureBaseColors(m._getInt(0), m._getInt(1), m._getReal(2));
	  break;
	}
#else
#ifdef _MSC_VER
...
#warning InterpolateColors module will be disabled. Upgrade PlantGL.
  ...
  DeclareModuleBegin(surface,
      ...
      switch (nbargs)
	{
	  ...
	  break;
	  case 1:
	    t.surface(m._getString(0), 1);
	  break;
	  default:
	    t.surface(m._getString(0), m._getReal(1));
	  break;
	}
    }
  DeclareModuleEnd
...
#warning Second argument of @g will be disabled. Upgrade PlantGL.
  ...
  DeclareModuleBegin(Frame,
      ...
      switch (nbargs)
	{
	  ...
	  break;
	  case 1:
	    t.frame(m._getReal(0));
	  break;
	  case 2:
	    t.frame(m._getReal(0), m._getReal(1));
	  break;
	  case 3:
	    t.frame(m._getReal(0), m._getReal(1), m._getReal(2));
	  break;
	  case 4:
	    t.frame(m._getReal(0), m._getReal(1), m._getReal(2), m._getReal(3));
	  break;
	  default:
	    t.frame(m._getReal(0), m._getReal(1), m._getReal(2), m._getReal(3), m._getReal(4));
	  break;
	}
#else
#ifdef _MSC_VER
...
#warning Frame module will be disabled. Upgrade PlantGL.
  ...
  DeclareModuleBegin(setcontour, "Set Cross Section of Generalized Cylinder. Params : 'Curve2D [, ccw]'.", ePrimitive)
	...
	{
	  case 0:
	    LsysWarning("missing argument to SetContour");
	  break;
	  case 1:
  ...
  DeclareModuleBegin(sectionResolution, "Set Resolution of Section of Cylinder. Params : 'resolution' (int).",
		     ePrimitive)
    {
      size_t nbargs = m.size();
      switch (nbargs)
	{
	  case 0:
	    LsysWarning("missing argument to SectionResolution");
	  break;
	  default:
  ...
  DeclareModuleBegin(setguide, "Set Guide for turtle tracing. Params : 'Curve[2D|3D], length [,yorientation, ccw]'.",
		     ePrimitive)
    {
#if PGL_VERSION >= 0x020B00
      size_t nbargs = m.size();
      switch (nbargs)
	{
	  ...
	  break;
	  case 1:
	    LsysWarning("missing argument to SetGuide");
	  break;
	  default:
  ...
  DeclareModuleBegin(positiononguide, "Set position on Guide for turtle tracing.", ePrimitive)
	...
	{
	  case 0:
	    LsysWarning("missing argument to PositionOnGuide");
	  break;
	  default:
  ...
  DeclareModuleBegin(sweep,
      ...
      switch (nbargs)
	{
	  ...
	  case 2:
	  case 3:
	    LsysWarning("missing argument to sweep");
	  break;
	  case 4:
	    {
	      bp::extract<Curve2DPtr> ec2d(m.getAt(0));
		...
		t.sweep(bp::extract<LineicModelPtr>(m.getAt(0))(), bp::extract<Curve2DPtr>(m.getAt(1))(), m._getReal(2),
			m._getReal(3));
	    }
	  break;
	  case 5:
	    {
	      bp::extract<Curve2DPtr> ec2d(m.getAt(0));
	      if (ec2d.check())
		t.sweep(ec2d(), bp::extract<Curve2DPtr>(m.getAt(1))(), m._getReal(2), m._getReal(3), m._getReal(4));
	      else
		t.sweep(bp::extract<LineicModelPtr>(m.getAt(0))(), bp::extract<Curve2DPtr>(m.getAt(1))(), m._getReal(2),
			m._getReal(3), m._getReal(4));
	    }
	  break;
	  default:
	    {
	      ...
	      if (ec2d.check())
		t.sweep(ec2d(), bp::extract<Curve2DPtr>(m.getAt(1))(), m._getReal(2), m._getReal(3), m._getReal(4),
			bp::extract<QuantisedFunctionPtr>(m.getAt(5))());
	      else
		t.sweep(bp::extract<LineicModelPtr>(m.getAt(0))(), bp::extract<Curve2DPtr>(m.getAt(1))(), m._getReal(2),
			m._getReal(3), m._getReal(4), bp::extract<QuantisedFunctionPtr>(m.getAt(5))());
	    }
	  break;
	}
#endif
  ...
  DeclareModuleBegin(TextureScale,
	...
	{
	  case 0:
	    LsysWarning("missing argument to TextureScale");
	  break;
	  case 1:
	    {
	  ...
	  if (fabs(valueU) < GEOM_EPSILON || fabs(valueV) < GEOM_EPSILON)
	    LsysWarning("invalid argument to TextureVCoeff. Should be non null.");
  ...
  DeclareModuleBegin(TextureUScale,
		     "Set the u-scale coefficient for texture application. Params : 'uscale' (default = 1).", eTexture)
    {
#if PGL_VERSION >= 0x020C00
      size_t nbargs = m.size();
      switch (nbargs)
	{
	  case 0:
	    LsysWarning("missing argument to TextureUScale");
	  break;
	  default:
  ...
  DeclareModuleBegin(TextureVScale,
		     "Set the v-scale coefficient for texture application. Params : 'vscale' (default = 1).", eTexture)
    {
#if PGL_VERSION >= 0x020C00
      size_t nbargs = m.size();
      switch (nbargs)
	{
	  case 0:
	    LsysWarning("missing argument to TextureVScale");
	  break;
	  default:
	    real_t value = m._getReal(0);
  ...
  DeclareModuleBegin(TextureTranslation,
	...
	{
	  case 0:
	    LsysWarning("missing argument to TextureTranslation");
	  break;
	  case 1:
	    t.setTextureTranslation(m._get<Vector2>(0));
	  break;
	  default:
  ...
  DeclareModuleBegin(TextureRotation,
      ...
      switch (nbargs)
	{
	  ...
	  break;
	  case 1:
	    t.setTextureRotation(m._getReal(0));
	  break;
	  case 2:
	    {
  ...
  DeclareModuleBegin(TextureTransformation,
      ...
      if (nbargs == 4)
	{
	  ...
	  if (ex.check())
		...
		t.setTextureTransformation(valueU, valueV, m._getReal(2), m._getReal(3), m._getReal(4), m._getReal(5),
					   m._getReal(6));
	    }
	}
    }
  ...
  DeclareSimpleModule(headingReflection, "The turtle change the heading vector to have a symmetric behavior.",
		      eRotation)

  DeclareModuleBegin(startScreenProjection, "The turtle will create geometry in the screen coordinates system.",
		     ePosition)
    {
#if PGL_VERSION >= 0x021200
  ...
  DeclareModuleBegin(endScreenProjection, "The turtle will create geometry in the world system (default behaviour).",
		     ePosition)
    {
#if PGL_VERSION >= 0x021200
...
#define CORE_DEC_PM(MName) ModuleClassPtr ModuleClass::MName;
  ...
  void ModuleClass::createPredefinedClasses()
  {
    ...
    ExactRightBracket = new PredefinedModuleClass("=]", "Match exactly a closing bracket",
						  PredefinedModuleClass::ePatternMatching);
    F = new DeclaredModule(F)("F");
    f = new DeclaredModule(f)("f");
    nF = new DeclaredModule(nF)("nF");
    X = new PredefinedModuleClass("X", "MouseIns",
				  "Module inserted just before module selected by user in visualisation.",
				  PredefinedModuleClass::eStringManipulation);
    Cut = new PredefinedModuleClass("%", "Cut", "Cut the remainder of the current branch in the string.",
				    PredefinedModuleClass::eStringManipulation);
    Star = new PredefinedModuleClass("*", "any",
				     "Used to match any module in rules predecessor. First argument will become name of the module.",
				     PredefinedModuleClass::ePatternMatching);
    RepExp = new PredefinedModuleClass("x", "repexp", "Used to specify matching of a repetition of modules.",
				       PredefinedModuleClass::ePatternMatching);
    RepExp->aliases.push_back("all");
    Or = new PredefinedModuleClass("or", "||", "Used to specify an alternative matching of modules.",
				   PredefinedModuleClass::ePatternMatching);
    ...
    GetIterator = new PredefinedModuleClass("?I", "GetIterator", "Request an iterator over the current Lstring.",
					    PredefinedModuleClass::ePatternMatching);
    GetModule = new PredefinedModuleClass("$", "GetModule", "Request a module of the current Lstring.",
					  PredefinedModuleClass::ePatternMatching);
    New = new PredefinedModuleClass("new", "newmodule", "Create a new module whose name is given by first argument.",
				    PredefinedModuleClass::eStringManipulation);
  }
