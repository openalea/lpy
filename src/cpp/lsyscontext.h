...
/*---------------------------------------------------------------------------*/
  ...
  class LPY_API LsysContext
  {
   public:
    ...
    inline bool hasStartFunction() const
    { return hasObject("Start"); }

    inline bool hasStartEachFunction() const
    { return hasObject("StartEach"); }

    inline bool hasEndFunction() const
    { return hasObject("End"); }

    inline bool hasEndEachFunction() const
    { return hasObject("EndEach"); }

    inline bool hasPostDrawFunction() const
    { return hasObject("PostDraw"); }

    inline bool hasStartInterpretationFunction() const
    { return hasObject("StartInterpretation"); }

    inline bool hasEndInterpretationFunction() const
    { return hasObject("EndInterpretation"); }
    ...
    inline size_t getEndEachNbArgs() const
    { return __nbargs_of_endeach; }

    inline size_t getEndNbArgs() const
    { return __nbargs_of_end; }

    inline size_t getStartEachNbArgs() const
    { return __nbargs_of_starteach; }

    inline size_t getStartNbArgs() const
    { return __nbargs_of_start; }
    ...
    getObject(const std::string &name, const boost::python::object &defaultvalue = boost::python::object()) const;
    ...
    virtual boost::python::dict locals() const
    { return __locals; };
    ...
    static inline LsysContext *currentContext()
    { return current(); }
    ...
    { __direction = eBackward; }

    inline void forward()
    { __direction = eForward; }

    inline bool isForward()
    { return __direction == eForward; }

    inline eDirection getDirection() const
    { return __direction; }

    /** selection of group of rules */
    inline void useGroup(size_t gid)
    { __group = gid; }

    inline size_t getGroup() const
    { return __group; }

    /** control of frame display */
    inline void frameDisplay(bool enabled)
    { __frameDisplay = enabled; }

    inline bool isFrameDisplayed() const
    { return __frameDisplay; }
    ...
    inline bool isAnimationEnabled() const
    { return __animation_enabled; }

    inline void setAnimationEnabled(bool enabled)
    { __animation_enabled = enabled; }
    ...
    inline bool isSelectionRequested() const
    { return __selection_requested; }

    inline const std::string &getSelectionMessage() const
    { return __selection_message; }
    ...
    inline bool warnWithSharpModule() const
    { return __warn_with_sharp_module; }

    void setWarnWithSharpModule(bool);

    /// Specify whether the axiom should be decomposed
    inline bool axiomDecompositionEnabled() const
    { return __axiom_decomposition_enabled; }

    void enableAxiomDecomposition(bool);

    /// Specify the multicore rewritting option
    inline bool multicoreProcessing() const
    { return __multicore; }

    void setMulticoreProcessing(bool enabled)
    { __multicore = enabled; }

    inline int brackectMappingOptimLevel() const
    { return __bracketmapping_optim_level; }

    void setBracketMappingOptimLevel(int level)
    { __bracketmapping_optim_level = level; }
    ...
    ModuleClassList declaredModules() const
    { return __modules; }
    ...
    inline void setReturnIfNoMatching(bool enabled)
    { return_if_no_matching = enabled; }

    /// optimization level
    static const int DEFAULT_OPTIMIZATION_LEVEL;
    int optimizationLevel;

    inline void setOptimizationLevel(int level)
