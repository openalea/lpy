...
PatternString::PatternString() : BaseType()
{ IncTracker(PatternString) }

PatternString::PatternString(const PatternModule &m) : BaseType()
{ IncTracker(PatternString) append(m); }

PatternString::PatternString(const_iterator beg, const_iterator end) : BaseType(beg, end)
{ IncTracker(PatternString) }

PatternString::~PatternString()
{ DecTracker(PatternString) }
